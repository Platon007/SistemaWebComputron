            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="container" id="cuerpo">
                        <div class="articulos">
                                <br/>
                                <h1 style="font-family: Trebuchet">TÉCNICO EN ADMINISTRACIÓN DE EMPRESAS</h1>
                                <br/>
                                <blockquote>La carrera de Administración de Empresas está diseñada para aquellas personas que deseen gestionar negocios de los diferentes sectores económicos, ya sean propios o no.

                                Un Administrador de Empresas tiene las competencias necesarias para gestionar los recursos de un negocio de manera eficiente, logrando máximos beneficios y sostenibilidad en el tiempo.</blockquote>
                        </div>         
                    </div>
				...
				<div class="panel">
                                    <p>
                                        <span class="glyphicon glyphicon-lock" aria-hidden="true" style="color: #30CCFF; font-size: 15px;"></span> Áreas de recursos humanos, logística, producción, finanzas y comercialización de todo tipo de organizaciones.<br/>
                                        <span class="glyphicon glyphicon-lock" aria-hidden="true" style="color: #30CCFF; font-size: 15px"></span> Empresas de logística y transporte nacional e internacional.<br/>
                                        <span class="glyphicon glyphicon-lock" aria-hidden="true" style="color: #30CCFF; font-size: 15px"></span> Empresas comerciales, industriales y de servicio.<br/>
                                        <span class="glyphicon glyphicon-lock" aria-hidden="true" style="color: #30CCFF; font-size: 15px"></span> Asesoría y consultoría empresarial.<br/>
                                        <span class="glyphicon glyphicon-lock" aria-hidden="true" style="color: #30CCFF; font-size: 15px"></span> En empresa propia.
                                    </p>
				</div>
				...
				<div class="panel">
				  <p>CERTIFICACIONES PROGRESIVAS AL TERMINAR CADA CICLO.</p>
                                  <span class="glyphicon glyphicon-ok-circle" aria-hidden="true" style="color: #30CCFF; font-size: 15px;"></span> PRIMERO: Auxiliar de oficina.<br/>
                                    <span class="glyphicon glyphicon-ok-circle" aria-hidden="true" style="color: #30CCFF; font-size: 15px;"></span> SEGUNDO: Asistente administrativo.<br/>
                                    <span class="glyphicon glyphicon-ok-circle" aria-hidden="true" style="color: #30CCFF; font-size: 15px;"></span> TERCERO: Asistente de comercio internacional.<br/>
                                    <span class="glyphicon glyphicon-ok-circle" aria-hidden="true" style="color: #30CCFF; font-size: 15px;"></span> CUARTO: Asistente de personal, asistente de producción.<br/>
                                    <span class="glyphicon glyphicon-ok-circle" aria-hidden="true" style="color: #30CCFF; font-size: 15px;"></span> QUINTO: Auxiliar de logistica.<br/>
                                    <span class="glyphicon glyphicon-ok-circle" aria-hidden="true" style="color: #30CCFF; font-size: 15px;"></span> SEXTO: Tecnico en proyectos empresariales.<br/>
				</div>
